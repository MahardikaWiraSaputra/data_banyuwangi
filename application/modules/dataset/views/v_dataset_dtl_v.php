                  ...
                  <div class="blog-wedget-text">
                      <div class="blog-wedget-heading">
                        <div class="left-side-title">
                						<h2 class="pt10">	Angka Partisipasi Kasar PAUD</h2>
                            <h3>Kode Referensi : 1.001.00000004</h3>
                	  		</div>
                      </div>
                          ...
                          <div class="blog-author-view">
                              <ul>
                                <li><a href="#!"><i class="icofont-building-alt"></i> Dinas Pendidikan</a>
                                  ...
                                  <!-- <li><a href="#!"><i class="icofont-book-alt"></i> Kecamatan</a>
                                  </li> -->
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="product-details-tabs">
						<div class="product-tabs-header">
							<ul class="nav nav-tabs">
								<li><a class="active" data-toggle="tab" href="#description">Deskripsi Data</a>
								</li>
								<li><a data-toggle="tab" href="#review">Metadata</a>
								</li>
							</ul>
						</div>
                  ...
                  <p>Dataset ini berisi data Angka Partisipasi kasar PAUD Kabupaten Banyuwangi dari tahun 2015 s.d. 2019.</p>
                    ...
                    <div class="table-desc">
                      ...
                      <li class="media">
                        <div class="media-body">
                          <div class="media-header">
                            <div class="media-name">
                              <h5>Pengukuran Dataset :</h5>
                              <p>Angka Partisipasi Kasar</p>
                            </div>
                          </div>
                        </div>
                      </li>
...
<section class="pricing-section bg-color">
    <div class="container">
        <div class="row justify-content-center pb10">
                ...
                <div class="upper-box clearfix">
                    <div class="tab-btn-box">
                        <ul class="tab-btns tab-buttons clearfix">
                            <li class="tab-btn active-btn" data-tab="#tab-1">Tabel</li>
                            <li class="tab-btn" data-tab="#tab-2">Grafik</li>
                        </ul>
                    </div>
                </div>
                <div class="tabs-content">
                    <div class="tab active-tab" id="tab-1" style="display: block;">
                        <div class="row clearfix praent">
